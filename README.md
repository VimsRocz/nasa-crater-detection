...
```bash
python code/crater_detector_final.py --data_folder /path/to/test/data --output solution.csv
```
...
python code/crater_detector_final.py --generate_sample ./sample_data

# Step 2: Run detection on sample data
python code/crater_detector_final.py --data_folder ./sample_data --output solution.csv
```
